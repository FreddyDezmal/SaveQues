...
export const DAILY_QUESTS: QuestTemplate[] = [
  ...
  },
  {
    id: "daily_save_10",
    title: "Save R10",
    description: "Log at least R10 in savings today — every bit counts.",
    type: "daily", category: "savings",
    xpReward: 60, icon: "🪙",
  },
  {
    id: "daily_round_up",
    title: "Round It Up",
    description: "Round up a purchase today and save the difference.",
    type: "daily", category: "savings",
    xpReward: 75, icon: "🔄",
  },
  {
    id: "daily_streak_guard",
    title: "Protect Your Streak",
    description: "Make sure today counts — keep your streak alive.",
    type: "daily", category: "streak",
    xpReward: 60, icon: "🛡️",
  },
  {
    id: "daily_price_compare",
    title: "Price Check",
    description: "Compare prices somewhere before you buy today.",
    type: "daily", category: "behavioral",
    xpReward: 60, icon: "🔍",
  },
  {
    id: "daily_no_spend_hour",
    title: "Golden Hour",
    description: "Go one full hour today without spending anything.",
    type: "daily", category: "behavioral",
    xpReward: 50, icon: "⏳",
  },
  {
    ...
    title: "Budget Glance",
    description: "Check today's spending against your plan.",
    type: "daily", category: "behavioral",
    xpReward: 50, icon: "📊",
  },
];
...
export const WEEKLY_QUESTS: QuestTemplate[] = [
  ...
  },
  {
    id: "weekly_save_1000",
    title: "Save R1,000",
    description: "Log a total of R1,000 in savings this week.",
    type: "weekly", category: "savings",
    xpReward: 700, icon: "💎",
  },
  {
    ...
    title: "Goal Momentum",
    description: "Make progress on a goal at least 3 times this week.",
    type: "weekly", category: "savings",
    xpReward: 400, icon: "📈",
  },
  {
    id: "weekly_no_subscriptions",
    title: "Subscription Audit",
    description: "Review your subscriptions and cancel one you don't use.",
    type: "weekly", category: "behavioral",
    xpReward: 300, icon: "📴",
  },
  {
    ...
    description: "Prep meals at home instead of eating out, 5+ days.",
    type: "weekly", category: "behavioral",
    xpReward: 400, icon: "🍱",
  },
  {
    ...
    description: "Keep your streak alive for all 7 days this week.",
    type: "weekly", category: "streak",
    xpReward: 500, icon: "🔥",
  },
  {
    id: "weekly_double_deposit",
    title: "Double Down",
    description: "Make at least 2 deposits on 3+ different days this week.",
    type: "weekly", category: "savings",
    xpReward: 450, icon: "💪",
  },
];
...
export const QUEST_CHAINS: QuestChain[] = [
  ...
  {
    id: "chain_century_saver",
    title: "Century Saver",
    description: "Big milestones, one deposit at a time.",
    icon: "💯",
    completionXP: 2500,
    steps: [
      { stepNumber: 1, title: "Save R2,000",             description: "Log R2,000 in total savings.",            xpReward: 300,  requiresType: "save_amount", requiresValue: 2000  },
      { stepNumber: 2, title: "Save R5,000",             description: "Log R5,000 in total savings.",            xpReward: 500,  requiresType: "save_amount", requiresValue: 5000  },
      { stepNumber: 3, title: "Save R10,000",            description: "Log R10,000 in total savings.",           xpReward: 700,  requiresType: "save_amount", requiresValue: 10000 },
      { stepNumber: 4, title: "Save R25,000",            description: "Log R25,000 in total savings.",           xpReward: 900,  requiresType: "save_amount", requiresValue: 25000 },
      { stepNumber: 5, title: "Save R50,000",            description: "Log R50,000 in total savings — a huge milestone.", xpReward: 1200, requiresType: "save_amount", requiresValue: 50000 },
    ],
  },
  {
    id: "chain_consistency_champion",
    title: "Consistency Champion",
    description: "Show up, week after week, and let it add up.",
    icon: "🏆",
    completionXP: 1800,
    steps: [
      { stepNumber: 1, title: "10-Day Streak",           description: "Active for 10 consecutive days.",         xpReward: 250,  requiresType: "streak",         requiresValue: 10 },
      { stepNumber: 2, title: "Perfect Attendance",      description: "Complete Perfect Attendance weekly quest.", xpReward: 400,  requiresType: "complete_quest", requiresValue: 1, requiresQuestId: "weekly_7_checkins" },
      { stepNumber: 3, title: "45-Day Streak",           description: "Active for 45 consecutive days.",         xpReward: 600,  requiresType: "streak",         requiresValue: 45 },
      { stepNumber: 4, title: "Ten Daily Quests",        description: "Complete 10 daily quests in total.",      xpReward: 550,  requiresType: "complete_daily", requiresValue: 10 },
    ],
  },
];
